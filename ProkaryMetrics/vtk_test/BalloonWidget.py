...
The balloon widget allows you to set up cartoon-style balloon messages. 
In this example balloon messages are shown when the mouse moves over either 
of the two rendered objects.
'''
from vtk import *
